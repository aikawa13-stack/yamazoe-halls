...
function activate(user, token) {
  ...
  document.body.classList.add("has-fixed-back"); const back = document.createElement("a"); back.className = "page-back page-back-fixed"; back.textContent = "TOPページに戻る"; document.body.append(back); setDateRange(); updateBackLink(); listenList(); renderPreview();
