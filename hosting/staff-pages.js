...
function startCalendar() {
  ...
  const reservationAlert = document.createElement("p"); reservationAlert.className = "reservation-alert"; reservationAlert.hidden = true; calendar.parentElement.insertBefore(reservationAlert, calendar);
